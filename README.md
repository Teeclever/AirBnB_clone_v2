# 0x02. AirBnB clone - The console

<p align="center">
  <img src='./technicals/HBNB.png' border='0' alt='Air-Bn-B-Project'/>
</p>
...
This repository contains the thrid stage of a student project to build a clone of the AirBnB website. This stage implements a database incorporation backend interface, or console, to manage program data using SQL. Console commands allow the user to create, update, and destroy objects, as well as manage file storage. Formerly using a system of JSON serialization/deserialization, storage is persistent between sessions.
...
## <center><h3>Repository Contents by Project Task for <br> AirBnB - The Console</h3> </center>
...
## <center><h3>Repository Contents by Project Task for <br> AirBnB Clone - MySQL</h3> </center>

| Task | File | 
| ---- | ---- |
| 0. Fork me if you can! | [Fork me if you can!](./AUTHORS) |
| 1. Bug free! | [Bug free!](./tests/) |
| 2. Console improvements | [Console improvements](./console.py) |
