...
<img src="./HBNB.png" alt="logo" width=80%>
...
* [packages concept page](./py_packages.md)
...
<img src="./server_side.png" alt="server_side-backend">
...
* Private class attributes:
	* `__file_path`: string - path to the JSON file (ex: `file.jso`n)
